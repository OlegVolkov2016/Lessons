...
public class Client implements Template {
	...
	public void print(String type) {
		// TODO Auto-generated method stub
		System.out.println("Client name: "+getName()+", discount: "+getDiscount()+"%.");		
	}
...
//		setDiscount(discount);
	...
	public String inputName(String type, boolean isNew) {
		...
		do {
			isMake = true;
			if (!isNew) System.out.println("Name of client: "+getName());
			System.out.print("Enter new name of client (only letters and .): ");
			name = makeNameChoise();
			if (name.equals("")) 
