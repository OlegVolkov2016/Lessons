...
public class RandomSolver implements FieldSolver {
	
	// Simple field generator
	private static RandomSolver instance = new RandomSolver();
	
	private RandomSolver() {
		// TODO Auto-generated constructor stub
	}
	
	public static RandomSolver getInstance() {
		return instance;
	}
